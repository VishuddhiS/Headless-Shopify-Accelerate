...
export declare const getTracking: (order: any) => string;
export declare const getTrackingUrl: (order: any) => string;
...
export declare const getShippingPrice: (order: any) => number | null;
export declare const getShippingAddress: (order: any) => string | null;
export declare const getCustomerName: (order: any) => string | null;
export declare const getCustomerPhone: (order: any) => string | null;
export declare const getItems: (order: any) => any[];
export declare const getItemSku: (item: any) => string;
export declare const getItemImage: (item: any) => string;
