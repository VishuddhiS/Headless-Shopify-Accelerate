...
const i18nCookiesPlugin = ({ $cookies, i18n, app, redirect }) => {
  const i18nOptions = {"currency":"USD","country":"US","countries":[{"name":"US","label":"United States"},{"name":"DE","label":"Germany"}],"currencies":[{"name":"EUR","label":"Euro"},{"name":"USD","label":"Dollar"}],"locales":[{"code":"en","alias":"us","label":"English","file":"en.js","iso":"en"},{"code":"ar","alias":"ar","label":"Arabic","file":"ar.js","iso":"ar","dir":"rtl"}],"defaultLocale":"en","lazy":true,"seo":true,"langDir":"lang\u002F","vueI18n":{"fallbackLocale":"en","numberFormats":{"en":{"currency":{"style":"currency","currency":"USD","currencyDisplay":"symbol"},"decimal":{"style":"decimal","minimumFractionDigits":2,"maximumFractionDigits":2},"percent":{"style":"percent","useGrouping":false}},"ar":{"currency":{"style":"currency","currency":"AED","currencyDisplay":"symbol"},"decimal":{"style":"decimal","minimumFractionDigits":2,"maximumFractionDigits":2},"percent":{"style":"percent","useGrouping":false}}}},"detectBrowserLanguage":{"useCookie":true,"cookieKey":"vsf-locale","redirectOn":"root","alwaysRedirect":true}};
