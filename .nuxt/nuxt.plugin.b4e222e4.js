...
const moduleOptions = JSON.parse('{"i18n":{"useNuxtI18nConfig":true},"locale":"en","currency":"USD","country":"US","acceptLanguage":["en","ar"],"countries":[{"name":"US","label":"United States"},{"name":"DE","label":"Germany"}],"currencies":[{"name":"EUR","label":"Euro"},{"name":"USD","label":"Dollar"}],"locales":[{"name":"en","label":"English"},{"name":"ar","label":"Arabic"}]}');
