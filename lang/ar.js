...
export default {
    ...
    'You haven\'t searched for items yet': 'You haven\'t searched for items yet',
    'Let\'s start now - we\'ll help you': 'Let\'s start now - we\'ll help you',
    'Take an EXTRA 20% Off Sale Items with Code ACCELERATE for Savings of Up to 70%! Limited time only': 'Take an EXTRA 20% Off Sale Items with Code ACCELERATE for Savings of Up to 70%! Limited time only',
    'Arabic': 'العربية',
    'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been.':'لوريم إيبسوم هو ببساطة نص شكلي يستخدم في صناعة الطباعة والتنضيد. لقد كان لوريم إيبسوم.',
